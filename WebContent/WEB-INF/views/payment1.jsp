...
<body>
	<div class="main">
						...
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
							<div class="payment-info">
								...
								<form action="orderstatus" method="post">
									...
									<form action="orderstatus" method="POST">
									 <a href="orderstatus" class="payment-info">Add Payment</a>
									</form>
								</form>
							...
							<div class="payment-info">
								...
								<div class="radio-btns">
									<div class="swit">
										<div class="check_box">
											<div class="radio">
												<label><input type="radio" name="radio" ><i></i>Andhra
													Bank</label>
											</div>
										</div>
										<div class="check_box">
											<div class="radio">
												<label><input type="radio" style="color:orange;"  name="radio" checked=""><i></i>Discover
													Bank</label>
											</div>
										</div>
										<div class="check_box">
									...
									<div class="swit">
										<div class="check_box">
											<div class="radio">
												<label><input type="radio" name="radio" ><i></i>City
													Union Bank</label>
											</div>
										</div>
										<div class="check_box">
									...
									<div class="user-login">
										...
										<form action="orderstatus" method="post">
											...
											<div class="user-grids">
												...
												<a href="orderstatus" class="payment-info">submit</a>
		...
		<p class="footer">
			Copyright © 2019 Online Payment Form| All Rights Reserved 
