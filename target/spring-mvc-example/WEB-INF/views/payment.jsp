...
<body>
	<div class="main">
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
										<div class="payment-info">
											...
											<div class="radio-btns">
												<div class="swit">								
													<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio" ><i></i>Andhra Bank</label> </div></div>
													<div class="check_box"> <div class="radio"> <label style="color:orange;"><input type="radio"  name="radio" checked><i></i>Discover Bank</label> </div></div>
												...
												<div class="swit">								
													<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio" ><i></i>City Union Bank</label> </div></div>
		...
		<p class="footer">Copyright © 2019 Online Book Store | All Rights Reserved</a></p>
	</div>
</body>
</html>