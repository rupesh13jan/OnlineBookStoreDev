...
<script>
	function getBooksDet() {
		...
		request.open('GET', 'http://localhost:8001/spring-mvc-example/Books/',
				true)
...
<body>
	...
	<section class="advanced-search advance-search-header">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<form action="searchBooks/null" method="POST">
		...
		<div class="body-left table-cell">
			<div class="info-row">
				...
				<div class="info-row phone text-right">
					<form action="CeleryJuice" method="POST">
						<a href="CeleryJuice" class="btn btn-primary">Add to cart <i
	...
	<div class="item-body table-cell">
		...
		<div class="body-left table-cell">
			<div class="info-row">
				<div class="label-wrap hide-on-grid">
					<a href="#"> <img src="<c:url value="/resources/Quiet.jpg" />" /></a>
					<div class="label-status label label-default">For Sale</div>
					<span class="label label-danger">In Stock</span>
				</div>
				<h2 class="property-title">
					<a href="#">Quiet</a>
				</h2>
	...
	<div class="item-body table-cell">
		...
		<div class="body-left table-cell">
			<div class="info-row">
				<div class="label-wrap hide-on-grid">
					<a href="#"> <img src="<c:url value="/resources/Body.jpg" />" /></a>
					<div class="label-status label label-default">For Sale</div>
	...
	<div class="item-body table-cell">
		...
		<div class="body-left table-cell">
			<div class="info-row">
				<div class="label-wrap hide-on-grid">
					<a href="#"> <img src="<c:url value="/resources/skinny.jpg" />" /></a>
					<div class="label-status label label-default">For Sale</div>
					<span class="label label-danger">Sold</span>
				</div>
				<h2 class="property-title">
	...
	<div class="item-body table-cell">
		...
		<div class="body-left table-cell">
			<div class="info-row">
				<div class="label-wrap hide-on-grid">
					<a href="#"> <img src="<c:url value="/resources/Eat.jpg" />" /></a>
					<div class="label-status label label-default">For Sale</div>
					<span class="label label-danger">Sold</span>
				</div>
				<h2 class="property-title">
